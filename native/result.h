...
{
public:
	Result(const T& value) : std::variant<ErrorMessage, T>(value) {}
	Result(const ErrorMessage& msg) : std::variant<ErrorMessage, T>(msg) {}
};
...
{
public:
	Result() : std::variant<ErrorMessage, std::monostate>(std::monostate{}) {}
	Result(const ErrorMessage& msg) : std::variant<ErrorMessage, std::monostate>(msg) {}
};
